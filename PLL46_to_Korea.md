...
|작성자|작성일|👍|내용|
|-|-|-|-|
|에프아이@초코보|2025.05.13 16:08|0|임무용 소지품은 항상 텅텅 비어있는데 빈 공간들을 활용하여 극, 절 난이도 우상 및 영웅 레이드 낱장, 일반 레이드에서의 낡은 장비들을 소지품에서 임무용 아이템에 소지하도록 변경되면 좋겠습니다.레이드 마다 낱장이나 우상 가지수가 많아 소지품 및 집사 소지품 관리에 있어 어려움이 많습니다.|
...
|재활@톤베리|2025.05.13 11:35|0|차단목록에 메모가 가능한것 처럼 친구창에도 메모 할 수 있는 기능을 추가해주실 수 없나요?오랜만에 들어왔는데 친구가 닉네임이 바꾸면 알아보기가 힘들고 말 걸기도 점점 애매해지는 상황이 오는 것 같아요! 메모해두면 누군지 쉽게 알 수 있고 좋을 것 같습니다!|
|Rose'lisa@모그리|2025.05.13 11:00|0|혹시 무작위 가맹 피시방도 '무작위 임무: 레벨링' 목적지 제한과 같은 가능을 해줄 수 있을까요? 개인적으론 랜덤성을 좋아하지만 미리 만들어진 파티의 경우 딜러가 둘 다 근딜인데 광역기가 없는 저렙 던전에 걸리면 힘들어서 있으면 좋을 꺼 같습니다!|
