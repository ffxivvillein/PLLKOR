...
|작성자|작성일|👍|내용|
|-|-|-|-|
|호노카@카벙클|2025.05.09 18:17|0|글로벌 서버에 패치를 맞춰가면서 업뎃 주기를 맞춰간다는 기사를 보았습니다 그렇다면 크리스탈라인 컨플릭트의 등급전 새 시즌 주기가 빠르게 돌아오거나 같은 변경사항이 있을까요? |
...
|소리엘윈@카벙클|2025.05.09 13:43|1|'파티 찾기'에 관한 건의입니다.1. 파티장의 닉네임이 아니라 모집내용에 대한 문구로는 검색이 불가능할까요?(예: 파밍팟에 가고싶을 경우 '파밍'이라는 검색어로 필터를 걸어 파티를 보고싶습니다)2. 현재 '고 난이도 임무' 탭에 등장하는 임무 수가 너무 많아 탭을 더 생성해 임무들을 세분화할수 있는지 요청하고싶습니다. 대상 임무가 현역 극만신, 해당 패치 시즌의 환 토벌전, 영웅 난이도 레이드1~4층, 그리고 절 레이드 6가지가 동시에 한 탭에 올라오다보니 원하는 파티를 찾아보기가 힘든 편입니다. 듣기로는 한국 서버가 다른 서버보다도 고난도 파찾 수가  많아서 발생하는 문제인것도 같은데, 현재 고난이도 임무로 분류되는 콘텐츠를 세분화해서 탭을 분리해주실 수 있을 지 요청해보고싶습니다.|
|에나나@초코보|2025.05.09 13:25|1|글로벌 서버와 패치 주기를 맞추느라 항상 고생 많으십니다! 그리고 감사합니다!이제 글로벌 서버와 거의 같은 진행 방식이 되어 갈 텐데 한국 서버에도 영어 보이스 더빙을 추가해 주실 계획이 있으실까요?프랑스어, 독일어 같은 보이스는 힘들 수 있어도 영어는 한국 서버 내에서도 꼭 적용해서 듣고 싶습니다. 순차적으로 패치되어도 좋으니 고려해주셨으면 좋겠습니다.|
