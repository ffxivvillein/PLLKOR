...
|작성자|작성일|👍|내용|
|-|-|-|-|
|비디오게임@모그리|2025.08.28 11:27|0|파판14 초보자 마크 (새싹)이 조건이 더 까다로워져야 한다고 생각합니다. 지금은 누구나 새로운 캐릭터를 만들면 초보자인데 계정 내 모든 캐릭터의 메인퀘스트 진행도를 고려해서 초보자 마크를 구분하는 시스템이 필요합니다. 이런 생각을 하게 된 이유는 초보자라는 자리를 악용하는 유저들이 너무 많다고 생각하기 때문입니다|
