...
|작성자|작성일|👍|내용|
|-|-|-|-|
|치즈빌런@카벙클|2025.01.22 23:43|0|인게임정보가 확인가능한 API를 공식지원할 계획이 있으신지요?|
|잠자는숲속의공룡@톤베리|2025.01.22 23:25|0|공룡, 고생물 관련 탈것, 꼬마 친구들(티라노사우루스, 스즈사우루스 등)의 이름은 모두 "루스"로 끝나는데 왜 꼬마 친구 '모사모사우르스'만 "르스"로 끝나나요? 라틴어 학명의 한글 표기 방식과 틀렸을 뿐더러 이름들의 일관성이 없는 것 같습니다.|
|마앙이@초코보|2025.01.22 21:36|0|다음 팬페나 이벤트는 역시 중간 지점인 대전 어떠신가요? (^^)|
|밀애@펜리르|2025.01.22 20:01|0|파판 TRPG 한국판 정발 해주시고 운영자 or 성우분들 모셔서 TRPG 플레이 방송을 해주셨으면 합니다|
|밀애@펜리르|2025.01.22 19:59|0|혹시 10주년 팬페.. 열리나요?|
|밀애@펜리르|2025.01.22 19:55|0|혹시 운영진중에 마작을 즐기는 분은 없을까요? 작패유희를 하거나 방법을 알려주는 방송이나 대회를 여는것은 어떨까요? (별개로 작패유희 점수계산법은 최악이라고 생각합니다 절대 반장전해 !!!)|
|밀애@펜리르|2025.01.22 19:53|0|황금 업데이트 이후 눈에 띄게 봇으로 추정되는 유저들이 늘어난 것 같은데요, (알수없는 닉으로 되어있는 라라펠 흑마도사 유저 대량증가) 신고의 방식은 일일히 스샷을 찍어서 보내드리기엔 너무 많은데, 대량의 봇을 신고할 수 있는 방법은 별도로 없을까요?|
|밀애@펜리르|2025.01.22 19:50|0|파판 서버 바꿨을때 고사 지내셨었나요? 순수하게 궁금합니다ㅋ|
|여훈@카벙클|2025.01.22 19:41|0|타격감 개선해주세요안되나요?|
|아나엔@모그리|2025.01.22 19:36|0|그리고 제발 여러 아이템 한번에 선택해서 옮기거나 할 수 있게 해주세요.|
|아나엔@모그리|2025.01.22 19:36|0|집사의 아이템 보관 창이 모두 통합되면 좋겠어요. 구매 여부에 따라 초코보 가방처럼 추가구역이 사용 가능해지는 형식으로,, 집사 하나하나 왔다갔다 하면서 템정리하고 옮기고 하려니까 힘들어요. 손목도 안좋아서 클릭 많이 하면 금세 지치는데,,|
|계룡산스라소니@펜리르|2025.01.22 19:32|0|파판14 TRPG 룰북 한국어 번역본은 정발하실 계획 있으실까요? 빛의 전사와 티알피져는 어느 정도 계층이 겹치는데다 파판14가 자기 캐릭터 만들어서 놀기 좋은 게임이라 룰북 정발하면 잘 팔릴 거 같은데... 일단 저는 살거에요...|
|유르겐'@카벙클|2025.01.22 19:08|0|제작하다 밥 떨어지면 앉아서 밥좀 먹게 해주세요ㅜㅜ 그리고 전에 요시P에게 긍정적인 반응이 나왔던 제작할 떄 제작수첩 열기는 언제 적용 될까요,,?|
|리데레@톤베리|2025.01.22 17:33|0|한국서버에도 동방학생복 출시 부탁드립니다|
|한지설@톤베리|2025.01.22 15:54|0|에오르제아 데이터베이스가 황금의 유산 업데이트 이후에 로딩 시간이 길어진것 같아요.필터 기능이 생겨 원하는 정보를 쉽게 얻어낼 수 있다는 점은 좋지만 특히 업데이트 직후 데이터 로딩하는 시간이 길어져 다른 사이트에서 검색해야 했습니다.. 시간이 지나고 꽤 괜찮아 진것 같으나 여전히 로딩 시간이 이전에 비해 길어진 것을 느낄 수 있습니다.. 해당 사항에 대해서 더 빠르게 로딩이 가능한 조치가 있을까요?|
...
|백설설탕@모그리|2025.01.22 12:44|1|다른 3도시 처럼 하우징 구역이 있는 시로가네,이슈가르드도 다른 에테라이트가 다른 서버로 이동 가능 할순 없을까요 ㅠㅠ?하우징 놀러갈때 너무 불편합니다 |
...
|하우징지박령@초코보|2025.01.22 12:02|2|건강에 좋은 샐러드나 샌드위치 같은 것과 콜라보 가능할까요!|
...
|텐메이@초코보|2025.01.20 01:27|3|비에라와 로스갈이 업뎃된지도 몇년이 흘렀습니다......... 처음에야 모델링이네 뭐네 문제로 (구)머리 장비들의 구현 문제를 받아들였지만 이제는 비에라와 로스갈 모두에게 머리장비를 구현시켜줄 때도 되지 않았나요? 심지어 비에라와 로스갈 출시 이전 장비는 백번 양보해 늦게 구현되는게 그렇다 치지만 출시 이후 장비들까지 미구현인건 정말 이상합니다 그리고 가장 큰 문제는 현금을 주고 산 유료 장비들 마저 머리 장비 구현이 안되는겁니다 이건 너무 심각한거 같아요이 점에 대해서 공지는 없나요?|
...
|산쥐@초코보|2025.01.17 12:38|4|한국한정 의상의 젠더락 해제 예정은 없을까요? 동방도령 의상 여캐로 입고 싶어요ㅠ...|
...
|라바카피@초코보|2025.01.16 22:16|4|한국 한정 의상으로 알고 있는 동방 도령, 동방 낭자 의상도 성별 제한을 풀어주시면 안 되나요? 여성 캐릭터로 동방 도령의 도포를 너무너무 입고 싶습니다...|
...
|세르덴@펜리르|2025.01.16 18:39|4|한국 한정 의상의 젠더락 해제 예정은 없을까요? 동방 도령 의상 여캐로 입고 싶은데 한섭 한정 의상이라.... 성별 상관없이 한복 입고 싶어요🥹|
...
|토레루@모그리|2025.01.16 17:46|17|19년도 vip 포인트에 대해 완화 패치를 한 이후 더이상 업데이트가 없는 상태입니다. 신규 유저들이 오래된 보상을 받기 어렵다는 취지는 이해하나, 포인트가 2만점이 넘어가는 기존 유저 입장에서는 차라리 1000점당 클러스터나 심층 지도 하나씩이라도 교환이 가능해지면 좋겠습니다... 신규나 복귀유저 위주로 혜택 이벤트가 자주 나오는데 저걸로라도 기존 유저들의 참여나 교환이 가능한 이벤트를 원합니다.|
