...
|작성자|작성일|👍|내용|
|-|-|-|-|
|똬루@카벙클|2024.08.16 22:39|0|팬페스티벌에 오지 못하는 분들을 위한 기조연설 이후 컨텐츠 (콘서트랑 프멀콘 쪽) 유료 스트리밍 방송 예정이 있을까요? [zaiko 같은 사이트에서...]|
|춘식이조련사@초코보|2024.08.16 16:57|0|혹시 중간에 잠시 나갔다가 재입장 가능한가요?|
...
|비아님@모그리|2024.08.16 12:14|0|지난 오프라인 팬페스티벌에서는 첫날 받은 입장팔찌를 다음날까지 훼손없이 착용하고 있어야 양일 입장이 가능했었는데요. 이는 이번 팬페도 동일한지 궁금합니다.|
|유다몽@모그리|2024.08.16 07:46|0|일본에서 진행된 오케콘에서는 엘피스꽃을 이용한 이벤트가 있었는데, 한국에서도 동일하게 진행될 예정인가요?어두운 공연장 내부에 빛나는 물건을 들고가게 되는 일인지라 정확하게 안내해주시면 감사할것같습니다.|
|하츠토리@톤베리|2024.08.16 05:43|0|수잔 캘러웨이님이 부른 앤서를 직접 듣는것이 인생의 버킷리스트 중 하나인데 이번 팬페에 수잔 캘러웨이님이 오실 계획은 없으실까요?|
|바닐라버터케이크@초코보|2024.08.15 23:48|1|제가 지병으로 인해 오래 걷기 힘든데, 킨텍스에서 자체적으로 휠체어를 대여해주는 서비스가 있대서 사용하려고 생각중인데요... 팬페스티벌에서 휠체어를 이용한 관람이 가능할까요?|
|궁합@모그리|2024.08.15 23:00|0|중국 서버의 경우 글로벌 서버와 패치 주기를 맞추는 것을 이야기했는데요 한국 서버도 그럴 계획이 있는지(중국 서버와 맞추는 것을 목표로 했으니까요?), 혹은 계획이 없다면 왜 없는지 궁금합니다. |
|락샤사@모그리|2024.08.15 20:56|0|던전 드랍 카드를 던전 클리어 횟수나 야만신의 경우 우상교환으로 습득이 가능하게 할 계획은 없나요?|
|로렌초@톤베리|2024.08.15 19:08|0|팬페스티벌 한정 질문이지만 오케스트라 콘서트도 이번행사의 일환일까 싶어 문의드립니다.혹시 오케스트라 콘서트 때 특별게스트를 모셔올 계획이 있는지 궁금합니다 (ex. 김윤아님, 하현우님, 서은광님 등등)|
...
|하츠토리@톤베리|2024.08.15 09:26|3|무대 행사들의 경우 지정좌석 없이 선착순으로 좌석에 앉는 것으로 알고있습니다. 자리를 맡아두는 목적으로 소지품을 두고 자리를 비우거나 한명이 일행을 위해 여러자리를 맡아두는 일들이 빈번하게 일어날경우 행사스탭분들이 따로 제재나 관리를 해주실까요? 원천적으로 막을 수 없다는 건 알고있지만 행사시간이 길고 인원이 인원인 만큼 도의적인 책임만으로는 관리가 어렵지않을까 걱정이 됩니다.|
|멜하@톤베리|2024.08.14 21:24|1|무대 행사를 하면 관람객들은 어떤 방식으로 무대를 보게되는지 궁금합니다! 좌석이 있다면 어떤 순서로 앉게 되는 건가요?|
...
|활자@초코보|2024.08.14 14:49|3|행사 세부일정이라도 미리 알려주시면 좋겠습니다. 몇시에 시작해서 몇시에 끝나는지 현재 알 수 있는 방법이 지난 펜페를 갔었던 다른 유저들한테 겨우 들을 수 있다는게... 레라 할 때 공개될 것 같긴 하지만 다른 분 말씀대로 세부일정이 나와야 그에 대한 영양가 있는 질문이 나올 거라고 생각합니다 지금 나온 정보로 계획 할 수 있는게 레라때 뜨는 일정 보고 며칠 뒤 풀리는 교통편 잡기밖에 없어서 ㅠ|
|할라할라@모그리|2024.08.14 14:40|2|팬페스티벌은 양일인데 입장관리를 어떻게 하실지 궁금합니다 저번 팬페 입장관리는 동일한 손목 띠를 이용해 양일입장을 해야하는 상황으로 분실, 파손등의 문제가 있었다고 들었는데 이번엔 다른 방향으로 진행하실지 궁금합니다|
...
|라프란체@카벙클|2024.08.14 14:35|6|팬페 1차 레라때 현실적으로 알려준건 티켓판매와 코스프레런웨이+아트콘테스트에 굿즈 홈쇼핑 밖에 없었고 행사에 대해서 아는게 하나도 없는데 행사관련 사전 Q&A로 뭘 질문하라는건지 모르겠네요 행사를 뭘 할지 대략적으로 알아야 질문이라도 하죠 이건 최소한 2차레라때 행사내용에 대해서 안내한 후에 질문받고 질문에대해 레라는 안해도 공지로 글로 답해야하는 Q&A아닌가요 |
